 ...
 * `-----------------------------------------/ Shift /     \ Shift\-----------------------------------------'
 *                   |  Pg  | Home | RAISE| / Enter /       \ Space\  |LOWER | End  |  Pg  |
 *                   |  Up  |      |      |/       /         \      \ |      |      |  Dn  |
 *                   `----------------------------'           '------''--------------------'
 */
 ...
 [_COLEMAK_DH] = LAYOUT(
  ...
  KC_LCTL,  KC_A,   CM_R,    CM_S,    CM_T,    KC_G,                       KC_M,    CM_N,    CM_E,    CM_I,    KC_O,    KC_QUOT,
  KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_D,    KC_V,   KC_EQL,    KC_MINS, KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
                             KC_PGUP, KC_HOME, RAISE,  ENT_L ,    SPC_R ,  LOWER,   KC_END,  KC_PGDN
),
/* QWERTY
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |  Esc |   1  |   2  |   3  |   4  |   5  |                    |   6  |   7  |   8  |   9  |   0  |  Bsp |
...
[_RAISE] = LAYOUT(
  ...
  _______, UNDO   , CUT    , COPY   , PASTE  , PASTE  , XXXXXXX, XXXXXXX,  XXXXXXX, KC_AMPR, KC_PIPE, XXXXXXX, XXXXXXX, _______,
                             RESET  , XXXXXXX, _______, _______, _______,  _______, XXXXXXX, XXXXXXX
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |  F1  |  F2  |  F3  |  F4  |  F5  |                    |  F6  |  F7  |  F8  |  F9  | F10  | F11  |
...
[_LOWER] = LAYOUT(
  ...
  _______, XXXXXXX, XXXXXXX, KC_LCBR, KC_RCBR, XXXXXXX, XXXXXXX, _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
                             XXXXXXX, XXXXXXX, _______, _______, _______, _______, XXXXXXX, RESET
),
/* ADJUST
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |QWERT |                    | COLEM|      |      |      |      |      |
